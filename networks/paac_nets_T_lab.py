...
class TlabFF_little(nn.Module):
    ...
    def _create_network(self,):
        ...
        self.fc3 = nn.Linear(C_out*H_out*W_out, 1)
        self.fc_policy = nn.Linear(1, self._num_actions)
        self.fc_value = nn.Linear(1, 1)
...
class TlabLSTM_little(nn.Module):
    ...
    def _create_network(self):
        ...
        self.lstm = nn.LSTMCell(C_out*H_out*W_out, 1, bias=True)
        self.fc_policy = nn.Linear(1, self._num_actions)
        self.fc_value = nn.Linear(1, 1)
